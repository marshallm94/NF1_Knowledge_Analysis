...
As with any statistical test, there are limitations imposed by the methods I have chosen to use. Contrary to Student's $t$-test, Welch's $t$-test does not assume that the variances of the two samples are equal. However, the assumption that the data is Normally distributed is maintained.
