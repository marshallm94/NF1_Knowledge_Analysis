...
############# commenting out for edits to labels for paper submission #############
...
other_parent_affected <- subset(grand.data, group_id == "Other Parent Affected")
...
tiff(filename = '../images/StatisticalTests.png',
     units = 'in',
     width = 8,
     height = 5,
     res = 300)
barplot(summary_df$average,
        ...
        main="Comparisons of NF1 Knowledge and Parental NF1 Status")
...
text(x=1.5, y=0.85, "*", pos=3, cex=3)
text(x=4.5, y=0.85, "*", pos=3, cex=3)
dev.off()
```
