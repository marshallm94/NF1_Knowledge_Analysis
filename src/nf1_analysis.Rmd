...
tiff(filename = '../images/EducationDistribution.png',
     ...
     height = 5,
     res = 300)
ggplot(display.df, aes(x = reorder(educational_background, -n),
                       y = n,
...
```{r pairwise_severity_of_symptoms}
display.df <-  grand.data[grand.data$how_would_you_describe_the_severity_of_your_nf1_symptoms. != "", c('how_would_you_describe_the_severity_of_your_nf1_symptoms.','how_would_you_describe_the_severity_of_symptoms_of_your_.oldest._child_with_nf1.')]

colnames(display.df) <- c('Parent','Child')

tiff(filename = '../images/SeverityOfSymptomsFamilialRelationship.png',
     units = 'in',
     width = 8,
     height = 5,
     res = 300)
ggpaired(display.df,
         ...
         fill = 'condition',
         xlab = "",
         ylab = "Severity of Symptoms",
         ggtheme = theme_gray()) +
  theme(legend.position = 'none') +
  ggtitle("Familial Relationship: Severity of Symptoms")
dev.off()

display.table <- table(display.df$Parent, display.df$Child)[2:5,]
knitr::kable(display.table,
             caption = 'Familial Relationship: Severity of Symptoms')
```

The plot associated with the above table is SeverityOfSymptomsFamilialRelationship.png, in the images directory.

\hfill

```{r pairwise_doctor_frequency}
display.df <-  grand.data[grand.data$how_often_do_you_see_doctor_for_nf_or_follow_at_an_nf_clinic. != "", c('how_often_do_you_see_doctor_for_nf_or_follow_at_an_nf_clinic.','how_often_does_your_.oldest._child_see_an_nf_doctor.')]

colnames(display.df) <- c('Parent','Child')

tiff(filename = '../images/FrequencyOfVisitsFamilialRelationship.png',
     units = 'in',
     width = 8,
     height = 5,
     res = 300)
ggpaired(display.df,
         ...
         ggtheme = theme_gray()) +
  theme(legend.position = 'none') +
  ggtitle("Familial Relationship: Frequency of Doctor Visits")
dev.off()
```

See the file FrequencyOfVisitsFamilialRelationship.png, in the images directory.
