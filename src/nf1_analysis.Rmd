...
# load & setup data
grand.data <- read.csv("/Users/marshallmcquillen/Data_Science/NF1_Knowledge_Analysis/data/grand_data.csv")
...
barplot(summary_df$average,
        ...
        space=c(0,0,1,0,1,0),
        axes=FALSE,
        ylab='Average NF1 Knowledge Score',
